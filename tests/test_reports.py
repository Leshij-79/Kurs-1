...
def test_spending_by_category(fixture_spending_by_category, fixture_list_user_operations_two_days) -> None:
    """
...
def test_spending_by_category_no_date(fixture_spending_by_category, fixture_list_user_operations_two_days) -> None:
    """
